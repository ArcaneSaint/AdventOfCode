...
//new Year2024.Day10Solver(36, 81).Solve();
//new Year2024.Day11Solver(55312, 65601038650482).Solve();
//new Year2024.Day12Solver(1930, 1206).Solve();
//new Year2024.Day13Solver(480, 875318608908).Solve();
//new Year2024.Day14Solver(12, 0).Solve();
//new Year2024.Day15Solver(10092, 9021).Solve();
//new Year2024.Day16Solver(11048, 64).Solve();
//new Year2024.Day17Solver("4,6,3,5,6,3,5,2,1,0", "117440").Solve();
//new Year2024.Day18Solver("22", "6,1").Solve();
//new Year2024.Day19Solver(6, 16).Solve();
//new Year2024.Day20Solver(10, 285).Solve();
...
//new Year2025.Day8Solver(40, 25272).Solve();
//new Year2025.Day9Solver(50, 24).Solve();
new Year2025.Day10Solver(7, 33).Solve();